...
import AttachedDocuments, {
  toAttachedDocuments,
  type AttachedDocument as AttachedDoc,
} from "@/components/student/AttachedDocuments";
...
const SubmitAssignmentDialog = ({
  ...
  const attachedDocs = toAttachedDocuments(assignment.assignment_attachments);
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        {attachedDocs.length > 0 && (
          <div className="py-2 border-b">
            <AttachedDocuments documents={attachedDocs} title="Reference materials" compact />
          </div>
        )}
