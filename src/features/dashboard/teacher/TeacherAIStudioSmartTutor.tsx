...
import SmartTutor from "@/components/ai/SmartTutor";
import { ArrowLeft } from "lucide-react";
import { cn } from "@/lib/utils";

const TeacherAIStudioSmartTutor = () => {
    ...
    <DashboardLayout role="teacher">
      <div className="space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-foreground">Smart Tutor</h1>
            <p className="text-muted-foreground mt-1">
              Adapt content for different learning levels and needs. Upload a doc or paste text.
            </p>
          </div>
        </div>
        ...
        <SmartTutor onContentGenerated={loadHistory} />
      </div>
    </DashboardLayout>
  );
};

export default TeacherAIStudioSmartTutor;
