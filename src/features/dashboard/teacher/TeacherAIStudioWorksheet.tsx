...
import WorksheetGenerator from "@/components/ai/WorksheetGenerator";
import { ArrowLeft } from "lucide-react";
import { cn } from "@/lib/utils";

const TeacherAIStudioWorksheet = () => {
  ...
  return (
    <DashboardLayout role="teacher">
      <div className="space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground mt-1">
              Choose a template and generate worksheet content with AI. Edit,
              regenerate questions, and export to PDF.
            </p>
          </div>
        </div>
        ...
        <WorksheetGenerator onContentGenerated={loadHistory} />
      </div>
    </DashboardLayout>
  );
};

export default TeacherAIStudioWorksheet;
